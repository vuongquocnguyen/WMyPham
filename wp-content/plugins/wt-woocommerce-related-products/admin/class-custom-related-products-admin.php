...
class Custom_Related_Products_Admin {
    ...
    */
    ...
    public function register_setting() {
        ...
        add_settings_field(
            $this->option_name . '_working_mode', __('Working mode', 'wt-woocommerce-related-products'), array($this, $this->option_name . '_working_mode_cb'), $this->plugin_name, $this->option_name . '_general', array('label_for' => $this->option_name . '_working_mode'),
        );
           add_settings_field(
        ...
        add_settings_field(
        $this->option_name . '_crp_title', __('Related products title', 'wt-woocommerce-related-products') . wc_help_tip( __('The entered text will be displayed as the title of related products recommendation on the store.','wt-woocommerce-related-products') ), array($this, $this->option_name . '_crp_title'), $this->plugin_name, $this->option_name . '_general', array('label_for' => $this->option_name . '_crp_title',
        'class' => 'crp-tr-field'),
        );

        add_settings_field(
            $this->option_name . '_crp_related_by', __('Display related products from', 'wt-woocommerce-related-products') . wc_help_tip( __('Based on the selection made, products from the same category and tag will be shown as recommendations.','wt-woocommerce-related-products') ) , array($this, $this->option_name . '_crp_related_by'), $this->plugin_name, $this->option_name . '_general', array('label_for' => $this->option_name . '_crp_related_by',
            'class' => 'crp-tr-field mode-default-disallow'),
        );

        add_settings_field(
            $this->option_name . '_crp_exclude_widget_category', __('Hide related products for categories', 'wt-woocommerce-related-products') .wc_help_tip( __('Select which categories should be excluded from displaying related products.','wt-woocommerce-related-products') ), array($this, $this->option_name . '_crp_exclude_widget_category'), $this->plugin_name, $this->option_name . '_general', array('label_for' => $this->option_name . '_crp_exclude_widget_category',
            'class' => 'crp-tr-field mode-default-disallow wt-gloablly-relate'),
        );

        add_settings_field(
            $this->option_name . '_crp_exclude_widget_product', __('Hide related products for products', 'wt-woocommerce-related-products') .wc_help_tip( __('Select individual products that should not display related products.','wt-woocommerce-related-products') ), array($this, $this->option_name . '_crp_exclude_widget_product'), $this->plugin_name, $this->option_name . '_general', array('label_for' => $this->option_name . '_crp_exclude_widget_product',
            'class' => 'crp-tr-field mode-default-disallow wt-gloablly-relate'),
        );

        add_settings_field(
            $this->option_name . '_crp_order_by', __('Sort by', 'wt-woocommerce-related-products') .wc_help_tip( __('Select the criteria for sorting related products.','wt-woocommerce-related-products') ), array($this, $this->option_name . '_crp_order_by'), $this->plugin_name, $this->option_name . '_general', array('label_for' => $this->option_name . '_crp_order_by',
            'class' => 'crp-tr-field mode-default-disallow'),
        );

        add_settings_field(
            $this->option_name . '_crp_order', __('Sort order', 'wt-woocommerce-related-products') .wc_help_tip( __('Choose whether to sort related products in ascending (A-Z, low to high) or descending (Z-A, high to low) order based on the selected criteria.','wt-woocommerce-related-products') ), array($this, $this->option_name . '_crp_order'), $this->plugin_name, $this->option_name . '_general', array('label_for' => $this->option_name . '_crp_order',
            'class' => 'crp-tr-field mode-default-disallow'),
        );
        add_settings_field(
            $this->option_name . '_slider', __('Slider', 'wt-woocommerce-related-products') .wc_help_tip( __('Turn on the product slider to allow customers to browse related products by swiping left or right.','wt-woocommerce-related-products') ), array($this, $this->option_name . '_slider_cb'), $this->plugin_name, $this->option_name . '_general', array('label_for' => $this->option_name . '_slider',
            'class' => 'crp-tr-field mode-default-disallow'),
        );
        add_settings_field(
        ...
        add_settings_field(
        $this->option_name . '_crp_number', __('Number of products to display', 'wt-woocommerce-related-products')  .wc_help_tip( sprintf( __('Choose the number of products to display as related products. This number must be greater than the %sNumber of products to display on the slider per page%s for the slider to function correctly. The default value is 4.','wt-woocommerce-related-products'),'<b>', '</b>')), array($this, $this->option_name . '_crp_number'), $this->plugin_name, $this->option_name . '_general', array('label_for' => $this->option_name . '_crp_number',
...
//        );
        add_settings_field(
            $this->option_name . '_crp_banner_width', __('Slider width', 'wt-woocommerce-related-products') .wc_help_tip( __('Alter the width of the related product section.','wt-woocommerce-related-products') ), array($this, $this->option_name . '_crp_banner_width'), $this->plugin_name, $this->option_name . '_general', array('label_for' => $this->option_name . '_crp_banner_width',
            'class' => 'crp-tr-field mode-default-disallow wt-slider-mode'),
        );        
        add_settings_field(
        ...
        add_settings_field(
            $this->option_name . '_exclude_os', __('Exclude out of stock products', 'wt-woocommerce-related-products') .wc_help_tip( __('Enable to exclude out of stock products from being displayed as related product recommendations.','wt-woocommerce-related-products') ), array($this, $this->option_name . '_exclude_os_cb'), $this->plugin_name, $this->option_name . '_general', array('label_for' => $this->option_name . '_exclude_os',
            'class' => 'crp-tr-field mode-default-disallow'),
        );  

        // Exclude Backorder products
        add_settings_field(
            $this->option_name . '_rp_exclude_backorder', __('Exclude Backorder products', 'wt-woocommerce-related-products') .wc_help_tip( __('Enable to exclude backorder products from being displayed as related product recommendations.','wt-woocommerce-related-products') ), array($this, $this->option_name . '_rp_exclude_backorder'), $this->plugin_name, $this->option_name . '_general', array('label_for' => $this->option_name . '_rp_exclude_backorder',
            'class' => 'crp-tr-field mode-default-disallow'),
        ); 
      
        add_settings_field(
            $this->option_name . '_use_primary_id_wpml', __("Use original product ID(WPML)", 'wt-woocommerce-related-products'), array($this, $this->option_name . '_use_primary_id_wpml_cb'), $this->plugin_name, $this->option_name . '_general', array('label_for' => $this->option_name . '_use_primary_id_wpml',
            'class' => 'crp-tr-field mode-default-disallow'),
        );
        add_settings_field(
            $this->option_name . '_overide_theme_rp', __("Override theme's template", 'wt-woocommerce-related-products') .wc_help_tip( __('Enable to override the theme’s existing template for related products.','wt-woocommerce-related-products') ), array($this, $this->option_name . '_overide_theme_rp_cb'), $this->plugin_name, $this->option_name . '_general', array('label_for' => $this->option_name . '_overide_theme_rp',
            'class' => 'crp-tr-field mode-default-disallow'),
        );
        add_settings_section(
    ...
    public function custom_related_products_crp_banner_width() {
        ...
        <fieldset class="crp-banner-width">
            <label>
                <input type="number" name="<?php echo $this->option_name . '_crp_banner_width'; ?>" id="<?php echo $this->option_name . '_crp_banner_width'; ?>" value="<?php echo esc_attr($crp_title); ?>" class="wt-crp-input"  min="50" max="150" required='required'>
            </label>
	...
	public function custom_related_products_crp_number() {
        ...
        <fieldset class="crp-number">
            <label>
                <input type="number" name="<?php echo $this->option_name . '_crp_number'; ?>" id="<?php echo $this->option_name . '_crp_number'; ?>" value="<?php echo esc_attr(absint($crp_number)); ?>" class="wt-crp-input" min="4" required="required">
            </label>
    ...
    public function custom_related_products_info_bottom_cb() {
        ...
        <div class="crp-alert crp-seconday-alert crp-info">
            <?php echo sprintf(__('Note: Alternatively, utilize the shortcode %s[wt-related-products product_id=XX]%s to showcase related products on custom posts/pages of your site. (Ensure to replace the %sXX%s placeholder in the shortcode with the product ID of the product you are basing the recommendation on, and related product recommendations for the selected product will be displayed on the chosen post/page.)', 'wt-woocommerce-related-products'), '<b>', '</b>','<b>', '</b>');?>
        </div>
        <?php
    }
